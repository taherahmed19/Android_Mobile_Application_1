...
public class MarkerModalFragment extends Fragment implements MarkerModalContract.View {
    ...
    void updateRatingValue(int rating){
        TextView markerRating = (TextView) this.getView().findViewById(R.id.markerRating);
        markerRating.setText(String.valueOf(rating));
    }

    void configureCloseButton(){
        ImageButton modalCloseButton = (ImageButton) this.getView().findViewById(R.id.modalCloseButton);
    ...
    void configureUpVoteButton(){
        this.upVoteButton = (ImageButton) this.getView().findViewById(R.id.upVoteButton);
    }

    void configureDownVoteButton(){
        this.downVoteButton = (ImageButton) this.getView().findViewById(R.id.downVoteButton);
    }
    ...
    void configureCategory() {
        TextView modalCategory = this.getView().findViewById(R.id.modalCategory);
    ...
    void configureDescription(){
        ...
        TextView modalDescription = (TextView) this.getView().findViewById(R.id.modalDescription);
    ...
    void configureName(){
        ...
        TextView text = this.getView().findViewById(R.id.marker_user_name);
    ...
    void renderImage(){
        ...
        ImageView markerImage = (ImageView) this.getView().findViewById(R.id.markerImage);
    ...
    void configureDeleteButton(){
        Button markerDeleteButton = (Button) this.getView().findViewById(R.id.markerDeleteButton);
